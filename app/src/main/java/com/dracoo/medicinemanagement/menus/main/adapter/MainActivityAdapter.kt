...
import com.dracoo.medicinemanagement.menus.direct_sale.view.ReportDirectSalesActivity
            ...
            itemMenuHomeCv.setOnClickListener {
                when (listMenu[position].title) {
                    ...
                    ConstantsObject.vReportDirectSales ->{
                        activity.startActivity(Intent(activity, ReportDirectSalesActivity::class.java))
                        activity.finish()
                    }
